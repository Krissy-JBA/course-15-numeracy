pageComponentry = {
  ...
  methods: {
    ...
    clickCorrect: function(correct){
     ...
     this.$parent.saveData('getting-up.' + correct, this.pageData[correct]);
     this.activateSubmit();
    },
    ...
    loadPageData: function(){
      for(var key in this.pageData){
        if(this.pageData.hasOwnProperty(key)){
          if(this.exerciseData['getting-up.' + key]){
            if(typeof this.exerciseData['getting-up.' + key] === 'string'){
              this.pageData[key] = (this.exerciseData['getting-up.' + key] === 'true');
            } else {
              this.pageData[key] = (this.exerciseData['getting-up.' + key] === true);
            }
          }
