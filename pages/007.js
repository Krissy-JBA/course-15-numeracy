pageComponentry = {
  ...
  methods: {
    ...
    clickCorrect: function(correct){
     ...
     this.$parent.saveData('arts.' + correct, this.pageData[correct]);
     this.activateSubmit();
    },
    ...
    loadPageData: function(){
      for(var key in this.pageData){
        if(this.pageData.hasOwnProperty(key)){
          if(this.exerciseData['arts.' + key]){
            if(typeof this.exerciseData['arts.' + key] === 'string'){
              this.pageData[key] = (this.exerciseData['arts.' + key] === 'true');
            } else {
              this.pageData[key] = (this.exerciseData['arts.' + key] === true);
            }
          }
