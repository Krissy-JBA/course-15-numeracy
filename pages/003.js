pageComponentry = {
  ...
  methods: {
    ...
    sendData: function() {
      ...
      this.$parent.saveData('chatting-on-the-mobile.visited', this.pageData.visited);
      // this.$parent.saveData('chatting-on-the-mobile.buttonValidate', this.buttonValidate);
    },
