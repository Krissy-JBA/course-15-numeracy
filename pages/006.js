pageComponentry = {
  ...
  methods: {
    ...
    clickCorrect: function(correct){
     ...
     this.$parent.saveData('writing-in-the-diary.' + correct, this.pageData[correct]);
     this.activateSubmit();
    },
    ...
    loadPageData: function(){
      for(var key in this.pageData){
        if(this.pageData.hasOwnProperty(key)){
          if(this.exerciseData['writing-in-the-diary.' + key]){
            if(typeof this.exerciseData['writing-in-the-diary.' + key] === 'string'){
