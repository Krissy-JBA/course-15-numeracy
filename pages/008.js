pageComponentry = {
  ...
  methods: {
    ...
    clickCorrect: function(correct){
     ...
     this.$parent.saveData('planning-at-outing.' + correct, this.pageData[correct]);
     this.activateSubmit();
    },
    ...
    loadPageData: function(){
      for(var key in this.pageData){
        if(this.pageData.hasOwnProperty(key)){
          if(this.exerciseData['planning-at-outing.' + key]){
            if(typeof this.exerciseData['planning-at-outing.' + key] === 'string'){
              this.pageData[key] = (this.exerciseData['planning-at-outing.' + key] === 'true');
            } else {
              this.pageData[key] = (this.exerciseData['planning-at-outing.' + key] === true);
            }
          }
