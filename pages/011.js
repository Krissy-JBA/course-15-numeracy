pageComponentry = {
  ...
  methods: {
    ...
    sendData: function() {
      ...
      this.$parent.saveData('decorating-the-home.visited', this.pageData.visited);
      // this.$parent.saveData('decorating-the-home.buttonValidate', this.buttonValidate);
    },
  ...
  ready: function() {
    ...
    t.pageData.visited = parseInt(t.exerciseData[ 'decorating-the-home.visited' ]);
    // t.buttonValidate = this.exerciseData[ 'decorating-the-home.buttonValidate' ];
  }
}
