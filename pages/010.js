pageComponentry = {
  ...
  methods: {
    ...
    clickCorrect: function(correct){
     ...
     this.$parent.saveData('having-a-dinner-party.' + correct, this.pageData[correct]);
     this.activateSubmit();
    },
    ...
    loadPageData: function(){
      for(var key in this.pageData){
        if(this.pageData.hasOwnProperty(key)){
          if(this.exerciseData['having-a-dinner-party.' + key]){
            if(typeof this.exerciseData['having-a-dinner-party.' + key] === 'string'){
              this.pageData[key] = (this.exerciseData['having-a-dinner-party.' + key] === 'true');
            } else {
              this.pageData[key] = (this.exerciseData['having-a-dinner-party.' + key] === true);
            }
          }
